...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 31 mai 2024 à 09:54
...
INSERT INTO `cv` (`id_cv`, `pdf`) VALUES
(1, '../pdfs/CV_Amaury.pdf'),
(2, '../pdfs/CV_Vincent.pdf'),
(3, '../pdfs/CV_Abderrahman.pdf');
...
(1, 2, 'Développeur IA'),
(2, 1, 'Apprenti SOC'),
(3, 1, 'Intégrateur Cybersécurité'),
(5, 3, 'Developpeur BackEnd'),
(6, 2, 'Testeur');
...
(1, 'Kamerer', 'amoriz', '0782452705', 'amaury.kamerer@esme.fr', 1),
